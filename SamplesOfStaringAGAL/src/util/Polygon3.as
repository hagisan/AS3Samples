package util
{
	...
	public class Polygon3 extends DisplayObject
	{		
...
//				mVertexData.setPosition(i, (1.5 - int(i/2))*edge.x, edge.y);
				mVertexData.setPosition(i, edge.x, edge.y);
//				mVertexData.setPosition(i, 2.0*edge.x, 0.2*edge.y);
				switch(i){
		...
		public override function render(support:RenderSupport, alpha:Number):void
		{
			...
			setupVertices(0/*0.2 * Math.sin(getTimer() / 200)*/, 0.2 * Math.sin(getTimer() / 200));
			createBuffers();
			setTexure();
